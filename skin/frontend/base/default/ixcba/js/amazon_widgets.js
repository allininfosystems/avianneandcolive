...
var AmazonWidgets = function (merchant_id, module_base_path){
	...
	this.createInlineWidget = function(session_path , inlinecallback, addressbook) {
	...
	this.createWalletWidget = function (displayMode) {
		...
		this.walletWidget = new CBA.Widgets.WalletWidget({
			...
			displayMode : displayMode,
				onPaymentSelect: function(widget) {																		document.getElementById("confirmAction").style.display = "inline-block";
