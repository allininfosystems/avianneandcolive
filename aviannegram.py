...
## 8am - 12pm / 3 random 2-3hour(random) intervals / 3 - 50 second random interval likes
...
hashtags = ["jewelry","celebrities","rings","diamonds","necklaces","chains","watches","bling","pendant","nyc","manhattan","hiphop","gold","jesuspiece","wedding","anniversary"]
##hashtagrand = random.choice(hashtags)
...
def like():
    ...
    sleepcount = 0
    for tag in hashtags:
        hashtaglikelimit = random.randrange(100, 602, 3)
        print "hash tag like limit = "+str(hashtaglikelimit)
        hashtaglikes = 0
                   ...
                   ## if hashtaglikelimit > 0 and hashtaglikes >= hashtaglikelimit:
                    ...
                    while repeat:
                        ...
                        if postData == '''{"status":"OK","message":"LIKED"}''':
                            ...
                            repeat = False
                            sleepcount = 0
                            sleeptimer = random.randrange(10, 15, 2)
