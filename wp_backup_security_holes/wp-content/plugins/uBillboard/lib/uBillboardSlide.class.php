...
class uBillboardSlide {
	...
	public function render()
	{
		...
		$out = "<li><p style='width:400px; overflow:hidden; background-color:#fff;'><span>$image_alt</span><img src='$image' alt='$image_alt' height='350' class='uds-bb-bg-image' /></p></li>\n";
		return $out;
	}
	...
	public function renderThumb()
	{
		...
		return "<img src=\"$image\" alt=\"\" width=\"$width\" height=\"$height\" />";
	}
